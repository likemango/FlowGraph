...
#include "MovieSceneNarrativeTrack.generated.h"

struct FMovieSceneEvaluationTrack;

/**
 * Implements a movie scene track that triggers events in the Narrative System during playback.
 */
UCLASS()
class NARRATIVE_API UMovieSceneNarrativeTrack
