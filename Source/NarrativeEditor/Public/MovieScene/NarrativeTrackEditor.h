...
*/
class NARRATIVEEDITOR_API FNarrativeTrackEditor : public FMovieSceneTrackEditor
{
public:
	/**
	 ...
	 * @param InSequencer The sequencer instance to be used by this tool.
	 */
	FNarrativeTrackEditor(TSharedRef<ISequencer> InSequencer);
...
private:
	void AddNarrativeSubMenu(FMenuBuilder& MenuBuilder);

	/** Callback for executing the "Add Event Track" menu entry. */
	void HandleAddNarrativeTrackMenuEntryExecute(UClass* SectionType) const;
