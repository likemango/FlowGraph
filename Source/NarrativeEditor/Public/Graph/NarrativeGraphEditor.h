 ...
 *
 */
class NARRATIVEEDITOR_API SNarrativeGraphEditor : public SGraphEditor
{
public:
	SLATE_BEGIN_ARGS(SNarrativeGraphEditor)
		{
		}
...
protected:
	TWeakObjectPtr<UNarrativeAsset> NarrativeAsset;
...
public:
	void Construct(const FArguments& InArgs, const TSharedPtr<FNarrativeAssetEditor> InAssetEditor);
...
public:
	...
	TSet<UNarrativeGraphNode*> GetSelectedNarrativeNodes() const;
...
private:
	...
	void SetSignalMode(const ENarrativeSignalMode Mode) const;
	bool CanSetSignalMode(const ENarrativeSignalMode Mode) const;
