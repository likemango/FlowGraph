...
#include "NarrativeGraphEditorSettings.generated.h"

UENUM()
enum class ENarrativeNodeDoubleClickTarget : uint8
{
 ...
 *
 */
UCLASS(Config = EditorPerProjectUserSettings, meta = (DisplayName = "Narrative Graph"))
class NARRATIVEEDITOR_API UNarrativeGraphEditorSettings : public UDeveloperSettings
{
	GENERATED_UCLASS_BODY()

	static UNarrativeGraphEditorSettings* Get() { return StaticClass()->GetDefaultObject<UNarrativeGraphEditorSettings>(); }

	// Double-clicking a Narrative Node might open relevant asset/code editor
	UPROPERTY(config, EditAnywhere, Category = "Nodes")
	ENarrativeNodeDoubleClickTarget NodeDoubleClickTarget;
