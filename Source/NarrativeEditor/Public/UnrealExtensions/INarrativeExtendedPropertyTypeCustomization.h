...
class NARRATIVEEDITOR_API INarrativeExtendedPropertyTypeCustomization : public IPropertyTypeCustomization
{
public:
...
template <class StructT>
StructT* INarrativeExtendedPropertyTypeCustomization::TryGetTypedStructValue(const TSharedPtr<IPropertyHandle>& StructPropertyHandle)
{
