...
#include "INarrativeExtendedPropertyTypeCustomization.h"
#include "Widgets/Input/SComboBox.h"

// A base-class to do property Customization for a struct that presents a curated list of FNames for selection
class NARRATIVEEDITOR_API INarrativeCuratedNamePropertyCustomization : public INarrativeExtendedPropertyTypeCustomization
{
protected:
	...
	// INarrativeCuratedNamePropertyCustomization
