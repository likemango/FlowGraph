...
#define LOCTEXT_NAMESPACE "NarrativeSection"

bool FNarrativeSectionBase::IsSectionSelected() const
{
...
void FNarrativeSectionBase::PaintEventName(FSequencerSectionPainter& Painter, int32 LayerId, const FString& InEventString, float PixelPos, bool bIsEventValid) const
{
...
int32 FNarrativeSection::OnPaintSection(FSequencerSectionPainter& Painter) const
{
...
int32 FNarrativeTriggerSection::OnPaintSection(FSequencerSectionPainter& Painter) const
{
	const int32 LayerId = Painter.PaintSectionBackground();

	UMovieSceneNarrativeTriggerSection* EventTriggerSection = Cast<UMovieSceneNarrativeTriggerSection>(WeakSection.Get());
...
int32 FNarrativeRepeaterSection::OnPaintSection(FSequencerSectionPainter& Painter) const
{
	const int32 LayerId = Painter.PaintSectionBackground();

	const UMovieSceneNarrativeRepeaterSection* EventRepeaterSection = Cast<UMovieSceneNarrativeRepeaterSection>(WeakSection.Get());
